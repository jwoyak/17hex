...
?>
   <?php echo $headline;
    ...
    <td><i>It is my Will to </i><input type="text" size="40" maxlength="40" name="intent"></td>
    <tr>
    <td align="right"><b>Font Face:</b></td>
    <td><select name="font">
      <option value="sgread">Ancient Greek</option>
      <option value="AnnabelScript">AnnabelScript</option>
...
?>
    ...
    <tr>
    <td align="right"><b>Statement of Intent:</b></td>
    <td><i>It is my Will to </i><input type="text" size="40" maxlength="40" name="intent" value="<?php echo $input; ?>"></td>
    <tr>
    <td align="right"><b>Font Face:</b></td>
    <td><select name="font">
